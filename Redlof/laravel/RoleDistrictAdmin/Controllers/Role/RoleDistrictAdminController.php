...
use Redlof\RoleDistrictAdmin\Controllers\Role\Requests\UpdateProfileRequest;
use Redlof\RoleDistrictAdmin\Controllers\Role\Requests\ChangePasswordRequest;
use Redlof\RoleDistrictAdmin\Controllers\Role\RoleDistrictAdminBaseController;

class RoleDistrictAdminController extends RoleDistrictAdminBaseController
{
	protected $user;
	...
	public function postChangePassword(ChangePasswordRequest $request)
	{
		...
		$show['redirect'] = ['/districtadmin/profile'];
	...
	function getSchoolInfo($application_cycle_year, $district_id, $nodal_id, $refresh='false')
	{
		...
		$cache_key = 'rte-district-getschoolinfo-api';
	...
	function applyFilterStudentDetails(Request $request, $refresh='false')
	{
		...
		$request->merge([
			'selectedDistrict' => $this->district->id
		]);

		$state_id = $this->state_id;

		$cache_key = 'rte-district-getstudentsinfo-api';
