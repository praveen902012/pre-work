    ...
    <div class="col-sm-6 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form name="changepassword" class="common-form add-area" ng-submit="create('districtadmin/password/change', passwordData, 'changepassword')" ng-init="passwordData={}">
                    ...
                    <div class="text-center">
                        <button ng-disabled="inProcess" type="submit" name="button" class="btn btn-success">
                            <span ng-if="!inProcess">Change Password</span>
