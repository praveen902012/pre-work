...
<section class="nodaladmin_dash cm-content" ng-controller="AppController" ng-cloak>
    <div class="container-fluid" ng-controller="ListController as List"
        ng-init="List.selectedCycle=null;List.init('student-list', {'getall': 'districtadmin/enrolledstudents', 'search': 'districtadmin/search/enrolledstudents'})"
        ng-cloak>
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="all-admin-link">
                    ...
                    <a href="{{ route('districtadmin.enrolledstudents') }}">
                        <button class="btn btn-primary">दाखिला लिया छात्र</button>
                    </a>
                </div>
            </div>
                ...
                <div class="pull-right">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                <li ng-repeat="cycle in admissionCycle"><a href=""
                                        ng-click="List.selectedCycle=cycle.session_year;List.init('student-list', {'getall': 'districtadmin/enrolledstudents?selectedCycle='+cycle.session_year, 'search': 'districtadmin/search/enrolledstudents?selectedCycle='+cycle.session_year})">[[cycle.session_year]]
                    ...
                    <div class="form-group" ng-controller="DownloadReportController as Download">
                        <button ng-if="List.ListService.results.length > 0" type="button" class="btn btn-warning"
                            ng-click="Download.triggerDownload('districtadmin/enrolledstudents/download?selectedCycle='+List.selectedCycle)"><i
