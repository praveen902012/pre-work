...
<section class="nodaladmin_dash cm-content" ng-controller="AppController" ng-cloak>
    <div class="container-fluid" ng-controller="ListController as List"
        ng-init="List.selectedCycle=null;List.init('student-list', {'getall': 'districtadmin/allstudents','search': 'districtadmin/search/allstudents'})"
        ng-cloak>
                ...
                <div class="pull-right">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                <li ng-repeat="cycle in admissionCycle"><a href=""
                                        ng-click="List.selectedCycle=cycle.session_year;List.init('student-list', {'getall': 'districtadmin/allstudents?selectedCycle='+cycle.session_year, 'search': 'districtadmin/search/allstudents?selectedCycle='+cycle.session_year})">[[cycle.session_year]]
                    ...
                    <div class="form-group">
                        <button ng-if="List.ListService.results.length > 0" type="button" class="btn btn-warning"
                            ng-click="Download.triggerDownload('districtadmin/allstudents/download?selectedCycle='+List.selectedCycle)"><i
                    ...
                    <div ng-if="List.ListService.results.length > 0">
                        <table class="table table-responsive custom-table table-bordered">
                            ...
                            <tr ng-repeat="student in List.ListService.results">
                                ...
                                <td ng-if="!student.status == 'completed'" class="text-center text-capitalize">
                                    [[student.status]]</td>
                                <td ng-if="student.status == 'completed'" class="text-center text-capitalize">
                                    [[student.registration_cycle.status]]</td>
                            </tr>
                        </table>
                        <div class="t-footer">
                            <div class="row">
