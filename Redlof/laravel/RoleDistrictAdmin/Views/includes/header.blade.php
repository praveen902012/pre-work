<div class="wrapper">
	<header class="admin-header app_navigation">
		<!-- Logo -->
		<a ui-sref="districtadmin.dashboard" class="logo">
				...
				<ul class="list-unstyled">
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img height="35" width="35" src="{{ $districtadmin->photo_thumb  }}" class="img-circle" alt="">
							<i class="fa ion-ios-arrow-down dropdown-icon" aria-hidden="true"></i>
						</a>
						<ul class="dropdown-menu dropdown-menu-right">
							<li>
								<a href="{{ route('districtadmin.dashboard') }}">डैशबोर्ड</a>
							</li>
							<li>
								<a href="{{ route('districtadmin.profile') }}">प्रोफ़ाइल</a>
							</li>
