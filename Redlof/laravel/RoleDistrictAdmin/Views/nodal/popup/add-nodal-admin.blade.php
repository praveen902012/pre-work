<section class="form-popup" ng-controller="AppController">
	...
	<div class="popup-content-ad" ng-init="formData.state_id=helper.state_id">
		<form name="districtadmin-nodal-admin"  ng-submit="create('districtadmin/add/nodaladmin', formData, 'districtadmin-nodal-admin')" ng-init="formData.state_slug=helper.state_slug">
			{{-- <div class="form-group">
				<label>
					Districts
				</label>
				<ui-select class="" ng-model="formData.district" theme="select2" ng-init="getDropdown('districtadmin/get/districts/'+[[helper.state_id]], 'districts')" >
