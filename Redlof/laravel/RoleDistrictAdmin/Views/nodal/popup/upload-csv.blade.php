<section class="form-popup" ng-controller="AppController">
	...
	<div class="popup-content-ad">
			<form name="upload-csv"  ng-submit="create('districtadmin/add/bulk-udise', uploadData, 'upload-csv')" ng-init="uploadData.district_id = helper.district_id">
				<div class="row">
					<div class="col-sm-12">
						<div class="bulk_upload padding-50">
							<div class="text-center">
								...
								<button ng-disabled="inProcess" type="submit" class="btn btn-success">
									<span ng-if="!inProcess">Upload</span>
