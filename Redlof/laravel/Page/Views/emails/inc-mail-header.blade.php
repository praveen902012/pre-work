...
<body style="margin: 0;padding: 0;">
   <table align="center" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;border: 1px solid #e0e0e0;">
      ...
      <tr>
         <td width="100%" style="padding: 10px; background-color: #008D94;">
            <a href="{!! url('/') !!}">
               <img width="auto" height="45px" src="{!! asset('img/rte_white_logo-home.png') !!}" alt="RTE" class="responsive-image"/>
            </a>
         </td>
      </tr>