            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <form name="admin-add-school" class="common-form add-area"
                        ng-submit="School.saveSchoolNeighbourhood('{{$udise}}')">
                        <div id="exTab1">
                            <ul class="nav nav-pills reg-nav-block ">
                                <li>
                                    <a href="{{route('schooladmin.edit-school')}}" class="step-link">1. Primary
                                        Details<br>&nbsp&nbsp&nbsp
                                        (प्राथमिक विवरण)
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('schooladmin.update-address',$school->udise)}}"
                                ...
                                <li>
                                    <a href="{{route('schooladmin.update-fee',$school->udise)}}" class="step-link">4.
                                        Fee & Seat Details<br>&nbsp&nbsp&nbsp
                                        (शुल्क और सीट विवरण)
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('schooladmin.update-bank',$school->udise)}}" class="step-link">5.
                                        Bank Details<br>&nbsp&nbsp&nbsp
                                        (बैंक सूचना)
                                    </a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane active" id="3a">
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 no-padding">
                                                <p class="text-theme-green pdb-5">[[School.range0.length]] selected
                                                    choices</p>
                                                <div class="school-list-box">
                                                    <table class="table table-fixed">
                                                        <thead>
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 no-padding">
                                                <p class="text-theme-green pdb-5">[[School.range0Dist.length]] selected
                                                    choices</p>
                                                <div class="school-list-box">
                                                    <table class="table table-fixed">
                                                        <thead>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-12">
                                            <button type="submit" class="btn-theme">Save & Continue</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
