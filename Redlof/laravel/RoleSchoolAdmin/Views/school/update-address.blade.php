            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <form name="admin-add-school" class="common-form add-area"
                        ng-submit="School.saveSchoolAddress('schooladmin/school/update/address/{{$udise}}')">
                        <div id="exTab1">
                                        ...
                                        <div class="col-md-4" ng-if="School.show_selection_type">
                                            <div class="form-group">
                                                <label>
                                                    ...
                                                    <p class="hindi-lbl">
                                                        (ईडब्लूएस कैटेगरी का आय प्रमाण ) <span
                                                            class="mand-field">*</span>
                                                    </p>
                                                </label>
                                        ...
                                        <div class="col-sm-4 col-xs-12" ng-if="School.show_selection_type">
                                            <div class="form-group form-field" click-off="School.localities.length = 0">
                                                ...
                                                <input ng-disabled="School.schoolData.block_id.length==0"
                                                    ...
                                                    ng-change="School.getLocalities('{{$state->slug}}', School.schoolData.sub_block_id, School.schoolData.locality_name)">
							...
							<div class="col-sm-8 col-xs-12">
								<div class="form-group form-field">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <button class="btn-theme step-link" type="submit">Update &amp;
                                                Continue</button>
                                        </div>
                                    </div>
                                </div>
