...
<section  class="nodaladmin_dash cm-content" ng-controller="AppController" ng-cloak>
	...
	<div ng-controller="ListController as List" >
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12">
				<div class="all-admin-link">
					...
					<a href="">
						<button class="btn btn-primary">Dropout Students</button>
					</a>
					<div class="rt-action  pull-right">
						...
						<div class="form-inline filter_by">
							...
							<div class="form-group">
								<button ng-click="List.init('student-list', {'getall': 'schooladmin/get/dropout-students/ac/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]], 'search': 'schooladmin/search/allotted-students/ac/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]]})" class="btn-theme btn-theme">Apply Filter</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div ng-init="List.init('student-list', {'getall': 'schooladmin/get/dropout-students/ac/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]], 'search': 'schooladmin/search/allotted-students/ac/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]]})" ng-cloak>
			<div class="row">
				...
				<div class="col-sm-2 col-xs-2" ng-controller="DownloadReportController as Download">
					<div class="form-group">
						<button ng-if="List.ListService.results.length > 0" type="button" class="btn btn-warning"
							ng-click="Download.triggerDownload('schooladmin/dropout-students/cycle/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]]+'/download')"><i
