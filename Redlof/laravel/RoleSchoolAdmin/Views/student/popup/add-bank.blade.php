	...
	<div ng-controller="SchoolController as School" class="popup-content-ad">
		<div class="tab-content clearfix">
			<div class="col-sm-12 col-xs-12">
				<form ng-submit="create('schooladmin/student/update-bank/'+ helper.registration_id, School.bankdetail, 'updatebankDetail')" name="updatebankDetail" class="common-form operator_signin_form">
