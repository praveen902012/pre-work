<section class="form-popup" ng-controller="AppController">
	...
	<div ng-controller="SchoolController as School" class="popup-content-ad">
		<div ng-init="School.getStudentBankDetails(helper.registration_id)" class="tab-content clearfix">
			<div class="col-sm-12 col-xs-12">
				<form ng-submit="create('schooladmin/student/update-bank-details/'+ helper.registration_id, School.bankdetail, 'updatebankDetail')" name="updatebankDetail" class="common-form operator_signin_form">
