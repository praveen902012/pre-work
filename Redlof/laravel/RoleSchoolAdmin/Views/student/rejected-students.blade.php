...
<section  class="nodaladmin_dash cm-content" ng-controller="AppController" ng-cloak>
	<div class="container-fluid" ng-controller="StudentController as Student">
		<div ng-controller="ListController as List">
						...
						<div class="rt-action  pull-right">
							<div class="form-inline filter_by">
								...
								<div class="form-group">
									<button ng-click="List.init('student-list', {'getall': 'schooladmin/get/rejected-students/ac/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]], 'search': 'schooladmin/search/rejected-students/ac/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]]})" class="btn btn-theme">Apply Filter</button>
								</div>
							</div>
						</div>
					</div>
			...
			<div ng-init="List.init('student-list', {'getall': 'schooladmin/get/rejected-students/ac/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]], 'search': 'schooladmin/search/rejected-students/ac/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]]})" ng-cloak>
				<div>
					<div class="row">
						...
						<div class="col-sm-2 col-xs-2" ng-controller="DownloadReportController as Download">
							<div class="form-group">
								<button ng-if="List.ListService.results.length > 0" type="button" class="btn btn-warning"
									ng-click="Download.triggerDownload('schooladmin/rejected-students/cycle/'+[[Student.selectedCycle]]+'/class/'+[[Student.selectedClass]]+'/download')"><i
							...
							<div class="col-sm-12 col-xs-12">
								<table class="table table-responsive custom-table">
									...
									<tr ng-repeat="student in List.ListService.results">
										...
										<td ng-show="student.fmt_status=='Dismissed'">Temporarily rejected</td>
										<td ng-show="student.fmt_status=='Rejected'">Rejected</td>
									</tr>
								</table>
								<div class="t-footer">
									<div class="row">
