							...
							<form class="">
								<div class="form-inline d_board_form">
										<div class="form-group">
											<div class="dropdown" ng-init="Student.initClass();Student.selectedClassName='Select Class'">
												<button class="btn btn-large dropdown-toggle" type="button" data-toggle="dropdown">[[Student.selectedClassName]]
												<span class="caret"></span></button>
												<ul class="dropdown-menu">
													<li ng-repeat="class in Student.classData">
														<a href="" ng-click="Student.selectedClass=class.id;Student.selectedClassName=class.level;List.init('student-list', {'getall': 'schooladmin/get/students/'+Student.selectedClass,'search': 'schooladmin/search/students/'+Student.selectedClass})" >[[class.level]]</a>
													</li>
												</ul>
											</div>
									</div>
						...
						<div ng-if="List.ListService.results.length > 0">
							<table class="table table-responsive custom-table">
								...
								<tr ng-repeat="student in List.ListService.results">
									...
									<td><a ng-href="/schooladmin/[[student.id]]/add-attendance">Add attendance ></a></td>
								</tr>
							</table>
							<div class="t-footer">
								<div class="row">
