...
<div class="state-single" ng-controller="AppController">
	<div class="container-fluid" ng-controller="ListController as List" ng-cloak ng-init="List.init('stateadmin-list', {'getall': 'admin/stateadmin/{{$state->id}}','search': 'admin/stateadmin/search/{{$state->id}}'})">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-xs-12">
					<div class="rt-action  pull-right">
						...
						<a class="btn-theme btn-blue mrgn-rt10" href="{{ route('admin.state.deactivated-state-admin', $state->slug) }}">
						Deactivated Admins
						</a>
