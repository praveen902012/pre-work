				...
				<div class="detail-card-st">
					<div class="row">
						...
						<div class="col-sm-3 col-xs-12">
							<a ng-really-action="Deactivate" ng-really-message="Do you want to deactivate this District Admin?" ng-really-click="create('admin/districtadmin/deactivate/{{$district_admin->id}}',  districtadmin, 'deactivate')" class="btn btn-danger pull-right">Deactivate</a>
						</div>
					</div>
				</div>
			</div>
