				...
				<div class="detail-card-st">
					<div class="row">
						...
						<div class="col-sm-3 col-xs-12">
							<a ng-really-action="Activate" ng-really-message="Do you want to activate this District Admin?" ng-really-click="create('admin/districtadmin/activate/{{$district_admin->id}}',  districtadmin, 'activate')" class="btn btn-success pull-right">Activate</a>
						</div>
					</div>
				</div>
			</div>
