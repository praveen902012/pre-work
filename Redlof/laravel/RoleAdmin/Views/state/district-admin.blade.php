...
<section class="admin_dash" ng-controller="AppController">
	<div class="container-fluid" ng-controller="ListController as List" ng-cloak ng-init="List.init('districtadmin-list', {'getall': 'admin/districtadmin/{{$district->id}}'})">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-xs-12">
					<div class="rt-action pull-right">
						...
						<a class="btn-theme btn-blue mrgn-rt10" ng-href="{{ $district->id }}/deactivated-district-admins">
							Deactivated Admins
						</a>
						<button class="btn-theme btn-blue" ng-click="helper.state_id={{$state->id}};helper.state_slug='{{$state->slug}}';helper.district_id='{{$district->id}}';openPopup('admin', 'state', 'add-district-admin', 'create-popup-style')">
						Add District Admin
						</button>
					</div>
				</div>
							...
							<table class="table table-responsive custom-table" >
								...
								<tbody>
									<tr ng-repeat="districtadmin in List.ListService.results">
										...
										<td>
											<button class="btn-brief" dynamic-content="[[ 'admin/districtadmin/brief/'+districtadmin.id ]]" dynamic-content-url="true">
											Brief
											</button>
										</td>
									</tr>
