                    ...
                    <table ng-if="List.ListService.results.length > 0" ng-cloak
                        ...
                        <tbody>
                            <tr ng-repeat="locality in List.ListService.results">
                                ...
                                <td>
                                    <button
                                        ng-click="helper.name = locality.name;helper.id = locality.id;helper.id = locality.id;openPopup('admin', 'state', 'edit-locality', 'create-popup-style')"
                                        class="btn btn-warning btn-xs city-action-btn">Edit</button>
                                    <button
                                        ng-click="helper.name = locality.name;helper.id = locality.id;openPopup('admin', 'state', 'delete-locality', 'create-popup-style')"
                                        class="btn btn-danger btn-xs city-action-btn">Delete</button>
                                    <button
                                        ng-click="helper.name = locality.name;helper.id = locality.id;helper.district_id = formData.district_id.id;openPopup('admin', 'state', 'assign-locality', 'create-popup-style')"
                                        class="btn btn-primary btn-xs city-action-btn">Reassign</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
