<section class="pp-addstate">
	...
	<div class="popup-content-ad" ng-controller="AppController" ng-init="formData={}">
		<form name="admin-add-locality" class="common-form add-area" ng-submit="create('admin/state/add/sub-block', formData, 'admin-add-locality')">
			...
			<div class="form-group">
				<label>
					Enter Sub Block Name
				</label>
				<input type="text" class="form-control" ng-model="formData.sub_block_name" placeholder="Enter sub block name">
			</div>
