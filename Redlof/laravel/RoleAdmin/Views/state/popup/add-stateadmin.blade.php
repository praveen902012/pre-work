<section class="form-popup" ng-controller="AppController">
	...
	<div class="popup-content-ad" ng-init="formData.state_id=helper.state_id">
		<form name="admin-add-city" class="common-form add-area" ng-submit="create('admin/state/admin/add', formData, 'admin-add-city')" ng-init="formData.state_slug=helper.state_slug">
