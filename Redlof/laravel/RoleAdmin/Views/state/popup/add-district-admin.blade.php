<section class="" ng-controller="AppController">
	...
	<div ng-init="formData={}">
		<div class="popup-content-ad" ng-init="formData.state_id=helper.state_id">
			<form name="admin-add-city" class="common-form add-area" ng-submit="create('admin/districtadmin/add', formData, 'admin-add-city')" ng-init="formData.state_slug=helper.state_slug;formData.district_id=helper.district_id">
