...
<section  class="nodaladmin_dash cm-content" ng-controller="AppController" ng-cloak>
	<div class="container-fluid">
		<div class="row">
			...
			<div ng-controller="ListController as List" ng-init="List.init('student-list', {'getall': 'admin/get/rejected-students/{{$state->id}}','search': 'nodaladmin/schools/search-registered'})" ng-cloak>
				<div>
						<div class="col-sm-12 col-xs-12">
