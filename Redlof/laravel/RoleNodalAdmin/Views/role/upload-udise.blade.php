...
<section class="admin_dash" ng-controller="AppController" ng-cloak>
	<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-xs-12">
					...
					<div class="rt-action pull-right">
						<a class="btn btn-primary" ng-href="pending-upload-udise">
						Pending Udise
						</a>
		...
		<div ng-controller="ListController as List" ng-cloak ng-init="List.init('nodaladmin-list', {'getall': 'nodaladmin/get/udise'})">
			<div class="row">

				<div class="col-sm-12 col-xs-12" ng-if="List.ListService.results.length>0">
					@include('page::app.tablelist-pagination')
					<h4>Recently Added Udise Numbers</h4><br>
