        ...
        <div class="">
            <!-- <div class="dash_hero_sec">
				<div class="state-profile">
					<img src="{{ $nodaladmin->photo_thumb  }}" class="img-responsive" alt="name">
					<h2>
					{{$nodaladmin->first_name}} - Nodal Admin
					</h2>
				</div>
			</div> -->
            <div class="dashboard_container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class=""
                            ng-init="Dashboard.formData.selectedCycle='{{$current_cycle}}';Dashboard.formData.selectedDistrict='{{ $state_nodal->district_id }}';Dashboard.formData.selectedNodal='{{ $state_nodal->id }}';Dashboard.formData.selectedSchool='null';Dashboard.formData.selectedSex='null';Dashboard.formData.selectedCategory='null';Dashboard.applyFilterStudentDetails('nodaladmin/apply-filter/student-details', Dashboard.formData);">
                            
                            <div class="row">
                                <div class="col-sm-8 col-xs-12">
                                    <div ng-show="Dashboard.show_student_details" ng-cloak>
                                        <form name="student-details" class="d_board_form"
                                            ng-submit="Dashboard.applyFilterStudentDetails('nodaladmin/apply-filter/student-details/true', Dashboard.formData)">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control" ng-model="Dashboard.formData.selectedCycle"
                                                            ...
                                                            <option value="[[cycle.session_year]]"
                                                                ng-repeat="cycle in Dashboard.admissionCycle">
                                                                [[cycle.session_year]] - [[cycle.session_year+1]]</option>
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-sm-4 col-xs-12" ng-if="Dashboard.show_school_information" ng-cloak>
                                    <button class="btn btn-info float-right" ng-disabled="!Dashboard.show_school_information"
                                        ng-click="Dashboard.getSchoolInfo(Dashboard.formData.selectedCycle,Dashboard.selectedDistrict,Dashboard.selectedNodal,'true');Dashboard.applyFilterStudentDetails('nodaladmin/apply-filter/student-details/true', Dashboard.formData)">
                ...
                <div class=""
                    ng-init="Dashboard.initAdmissionCycle();Dashboard.selectedCycle='{{$current_cycle}}';Dashboard.selectedDistrict='{{ $state_nodal->district_id }}';Dashboard.selectedNodal='{{ $state_nodal->id }}';Dashboard.getSchoolInfo(Dashboard.selectedCycle,Dashboard.selectedDistrict,Dashboard.selectedNodal)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12" style="padding:10px">
                                <div class="ttl_new_count_card">
                                    ...
                                    <p>Schools with 0 applications (Schools which didn’t get any application from
                                        students)</p>
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12" style="padding:10px">
                                <div class="ttl_new_count_card">
                                    ...
                                    <p>Schools with >0 application and no admission( Had some allotment but no
                                        enrollment)</p>
                                </div>
                            </div>
