                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-wrapper">
                                    <div class="form-spacing">
                                        <form
                                            ng-submit="create('nodaladmin/school/update/bank/{{$udise}}', School.bankdetail, 'updatebankDetail')"
                                            ...
                                            <div class="form-group form-field">
                                                <div class="">
                                                    ...
                                                    <input ng-disabled="{{$disable_edit}}" validator="required"
                                                        valid-method="blur" type="text" class="form-control"
                                            ...
                                            <div class="form-group form-field">
                                                <div class="">
                                                    ...
                                                    <input ng-disabled="{{$disable_edit}}" validator="required"
                                                        valid-method="blur" min="0" type="text" class="form-control"
                                            ...
                                            <div class="form-group form-field" ng-init="banks = helper.allBanks()">
                                                <div class="">
                                                    ...
                                                    <input ng-disabled="{{$disable_edit}}" validator="required"
                                                        valid-method="blur" type="text" class="form-control"
                                                        ng-model="School.bankdetail.bank_name" id="account_number"
                                            ...
                                            <div class="form-group form-field">
                                                <div class="">
                                                    ...
                                                    <input ng-disabled="{{$disable_edit}}" valid-method="blur"
                                            ...
                                            <button ng-disabled="{{$disable_edit}}"
                                                ng-disabled="updatebankDetail.$invalid" type="submit"
