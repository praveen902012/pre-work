...
<section class="nodaladmin_dash cm-content" ng-controller="AppController" ng-cloak>
    <div class="container-fluid" ng-controller="ListController as List"
        ...
        <div class="row">
                    ...
                    <span class="form-group">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li>
                                    <a href="#"
                                        ng-click="List.year={{$year}};List.cycle='{{$year}} - {{$year+1}}'; List.init('student-list', {'getall': 'nodaladmin/get/school/all/list/?selectedCycle={{$year}}','search': 'nodaladmin/schools/search/list/?selectedCycle={{$year}}'})">
                                        {{$year}} - {{$year+1}}
                                    </a>
                                </li>
                                @endforeach
            ...
            <div ng-init="List.init('school-list', {'getall': 'nodaladmin/get/school/all/list','search': 'nodaladmin/schools/search/list'})"
                ng-cloak>
                <div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="col-sm-5 col-xs-12">
                            <div class="rt-action  pull-right" ng-controller="DownloadReportController as Download">
                                <button ng-if="List.ListService.results.length > 0" type="button"
                                    ...
                                    ng-click="Download.triggerDownload('nodaladmin/get/schools/all/download/list?selectedCycle='+List.year)">
                    ...
                    <div ng-if="List.ListService.results.length > 0">
                        <table class="table table-responsive custom-table">
                            ...
                            <tr ng-repeat="school in List.ListService.results">
                                ...
                                <td class="text-capitalize">[[school.school.application_status]]</td>
                            </tr>
                        </table>
                        <div class="t-footer">
                            <div class="row">
