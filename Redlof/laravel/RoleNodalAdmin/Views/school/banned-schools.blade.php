    ...
    <div class="container-fluid" ng-controller="ListController as List"
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="all-admin-link pull-right" ng-init="latest_session_year={{$latest_application_cycle->session_year}}">
                    <span class="form-group">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li>
                                    <a href="#"
                                        ng-click="List.year={{$year}};List.cycle='{{$year}} - {{$year+1}}'; List.init('student-list', {'getall': 'nodaladmin/get/banned-schools/?selectedCycle={{$year}}','search': 'nodaladmin/schools/search-banned?selectedCycle={{$year}}'})">
                                        {{$year}} - {{$year+1}}
                                    </a>
                                </li>
                                @endforeach
            ...
            <div ng-init="List.init('school-list', {'getall': 'nodaladmin/get/banned-schools','search': 'nodaladmin/schools/search-banned'})"
                ng-cloak>
                <div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="col-sm-5 col-xs-12">
                            <div class="rt-action  pull-right" ng-controller="DownloadReportController as Download">
                                <button ng-if="List.ListService.results.length > 0" type="button"
                                    ...
                                    ng-click="Download.triggerDownload('nodaladmin/get/banned-schools/download?selectedCycle='+List.year)">
                            ...
                            <tr ng-repeat="school in List.ListService.results">
                                ...
                                <td>
                                    ...
                                    @if($all_application_cycle->where('status', 'new')->count())
                                        {{-- <button ng-if="latest_session_year==school.session_year" ng-really-action="Unban"
                                        ng-really-message="Do you want to unban this school?"
                                        ng-really-click="create('nodaladmin/school/unban/'+[[school.school.id]],  school, 'unban')"
                                        class="btn btn-success btn-xs city-action-btn">Unban</button> --}}
                                    @endif
