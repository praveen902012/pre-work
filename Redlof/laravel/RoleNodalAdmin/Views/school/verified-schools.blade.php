...
<section class="nodaladmin_dash cm-content" ng-controller="AppController" ng-cloak>
    <div class="container-fluid" ng-controller="ListController as List"
        ...
        <div class="row">
                    ...
                    <span class="form-group">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li>
                                    <a href="#"
                                        ng-click="List.year={{$year}};List.cycle='{{$year}} - {{$year+1}}'; List.init('student-list', {'getall': 'nodaladmin/get/verified-schools/?selectedCycle={{$year}}','search': 'nodaladmin/schools/search-registered?selectedCycle={{$year}}'})">
                                        {{$year}} - {{$year+1}}
                                    </a>
                                </li>
                                @endforeach
            ...
            <div ng-init="List.init('school-list', {'getall': 'nodaladmin/get/verified-schools','search': 'nodaladmin/schools/search-registered'})"
                ng-cloak>
                <div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="col-sm-5 col-xs-12">
                            <div class="rt-action  pull-right" ng-controller="DownloadReportController as Download">
                                <button ng-if="List.ListService.results.length > 0" type="button"
                                    ...
                                    ng-click="Download.triggerDownload('nodaladmin/get/registered-schools/download?selectedCycle='+List.year)">
                            ...
                            <tr ng-repeat="school in List.ListService.results">
                                ...
                                <td>
                                    @if($all_application_cycle->where('status', 'new')->count())
                                        ...
                                        <!-- <button ng-click="helper.school_id=[[school.school.id]];openPopup('nodaladmin', 'school', 'reject-school', 'create-popup-style')"
                                            class="btn btn-danger btn-xs city-action-btn">Reject</button>

                                        <a ng-if="latest_session_year==school.session_year" ng-href="school/[[school.school.id]]/edit-school"><button
                                                class="btn btn-info btn-xs city-action-btn">Edit</button></a>

                                        <button ng-if="latest_session_year==school.session_year" ng-really-action="Ban" ng-really-message="Do you want to ban this school?"
                                            ng-really-click="create('nodaladmin/school/ban/'+[[school.school.id]],  school, 'ban')"
                                            class="btn btn-danger btn-xs city-action-btn">Ban</button>
                                        ...
                                        <button ng-if="latest_session_year==school.session_year"
                                            ...
                                            class="btn btn-warning btn-xs city-action-btn">Recheck</button> -->

                                    @endif

                                    <a href="school/[[school.school.id]]" target="_blank"><button
                                            class="btn btn-success btn-xs city-action-btn">Details</button></a>
                                </td>
                            </tr>
                        </table>
                        <div class="t-footer">
