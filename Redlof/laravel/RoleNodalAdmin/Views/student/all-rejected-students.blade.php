        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <div class="all-admin-link">
                    ...
                    <a href="">
                        <button class="btn btn-primary">खारिज किए गये छात्र</button>
                    </a>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li ng-repeat="cycle in admissionCycle"><a href=""
                                    ng-click="List.selectedCycle=cycle.session_year;List.init('student-list', {'getall': 'nodaladmin/allrejected-students?selectedCycle='+cycle.session_year, 'search': 'nodaladmin/allrejected-students/search?selectedCycle='+cycle.session_year })">[[cycle.session_year]]
                                    - [[cycle.session_year+1]]</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div ng-init="List.init('student-list', {'getall': 'nodaladmin/allrejected-students','search': 'nodaladmin/allrejected-students/search'})"
                ng-cloak>
                <div>
                    <div class="col-sm-6 col-xs-12">
