            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="all-admin-link">
                    <a href="{{route('nodaladmin.students.verify')}}">
                        <button class="btn btn-default">कुल छात्र</button>
                    </a>
                    <a href="{{ route('nodaladmin.students.verifed') }}">
                        <button class="btn btn-default">सत्यापि छात्र</button>
                    </a>
                    <a href="">
                        <button class="btn btn-primary">अस्वीकार किए गये छात्र</button>
                    </a>
                </div>
            </div>
            <div ng-controller="ListController as List"
                ng-init="List.init('student-list', {'getall': 'nodaladmin/rejectedstudentsdocs','search': 'nodaladmin/rejected-student/searchByName'})"
                ng-cloak>
                <div>
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div class="rt-action  pull-right" ng-controller="DownloadReportController as Download">
                            <button ng-if="List.ListService.results.length > 0" type="button"
                                ...
                                ng-click="Download.triggerDownload('nodaladmin/rejecteddocstudents/download')"><i
                                    ...
                                    {{-- <div ng-controller="ToBeVerifiedStudent as DocVerify">
                                        <div ng-if="student.doc_verification_status=='Rejected'"
                                            ...
                                            <button class="btn btn-info" 
                                                ng-click="create('nodaladmin/students/undo/'+[[student.basic_details.id]])">
                                                Undo
                                            </button>
                                        </div>
                                    </div> --}}
