		...
		<div class="row">
			...
			<div class="col-sm-12 col-xs-12">
				...
				<div class="all-admin-link">
					<a href="">
						<button class="btn btn-primary">Registered Students</button>
					</a>
			...
			<div ng-controller="ListController as List" ng-init="List.init('student-list', {'getall': 'nodaladmin/registeredstudents'})" ng-cloak>
				<div>
					<div class="col-sm-12 col-xs-12">
