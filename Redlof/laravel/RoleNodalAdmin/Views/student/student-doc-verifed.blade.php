        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="all-admin-link">
                    ...
                    <a href="">
                        <button class="btn btn-primary">सत्यापि छात्र</button>
                    </a>
            ...
            <div ng-controller="ListController as List"
                ng-init="List.init('student-list', {'getall': 'nodaladmin/verifiedstudentsdocs', 'search': 'nodaladmin/verified-student/searchByName'})"
                ng-cloak>
                <div>
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div class="rt-action  pull-right" ng-controller="DownloadReportController as Download">
                            <button ng-if="List.ListService.results.length > 0" type="button"
                                ...
                                ng-click="Download.triggerDownload('nodaladmin/verifieddocstudents/download')"><i
