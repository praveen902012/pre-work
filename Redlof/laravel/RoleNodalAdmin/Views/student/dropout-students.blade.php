            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="all-admin-link">
                    ...
                    <a href="{{ route('nodaladmin.dropout.pending') }}">
                        <button class="btn btn-default">अपूर्ण सूची</button>
                    </a>
                    <a href="">
                        <button class="btn btn-primary">शाला त्यागी छात्र</button>
                    </a>

                </div>
            </div>
            <div ng-controller="ListController as List"
                ng-init="List.init('student-list', {'getall': 'nodaladmin/dropout/verified'})" ng-cloak>
                <div>
                    <div class="col-sm-12 col-xs-12">
