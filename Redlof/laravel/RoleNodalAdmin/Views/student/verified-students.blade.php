        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <div class="all-admin-link">
                    ...
                    <a href="">
                        <button class="btn btn-primary">सत्यापित छात्र</button>
                    </a>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li ng-repeat="cycle in admissionCycle"><a href=""
                                    ng-click="List.selectedCycle=cycle.session_year;List.init('student-list', {'getall': 'nodaladmin/verifiedstudentsdocs?selectedCycle='+cycle.session_year, 'search': 'nodaladmin/verified-student/searchByName?selectedCycle='+cycle.session_year })">[[cycle.session_year]]
            ...
            <div ng-init="List.init('student-list', { 'search': 'nodaladmin/verified-student/searchByName', 'getall': 'nodaladmin/verifiedstudentsdocs?selectedCycle='+cycle.session_year})"
                ng-cloak>
                <div>
                    <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="col-sm-5 col-xs-12">
                        <div class="rt-action  pull-right" ng-controller="DownloadReportController as Download">
                            <button ng-if="List.ListService.results.length > 0" type="button"
                                ...
                                ng-click="Download.triggerDownload('nodaladmin/verifieddocstudents/download?selectedCycle='+List.selectedCycle)"><i
                            ...
                            <tr ng-repeat="student in List.ListService.results">
                                ...
                                <td class="text-capitalize">
                                    @if($all_application_cycle->where('status', 'new')->count())
                                        <!-- <div ng-if="student.application_cycle_id=={{$latest_application_cycle->id}}" class="btn-docverify[[student.basic_details.id]]">
