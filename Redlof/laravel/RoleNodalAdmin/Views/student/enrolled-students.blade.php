                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li ng-repeat="cycle in admissionCycle"><a href=""
                                    ng-click="List.selectedCycle=cycle.session_year;List.init('student-list', {'search': 'nodaladmin/enrolledstudents/searchByName?selectedCycle='+cycle.session_year, 'getall': 'nodaladmin/enrolledstudents?selectedCycle='+cycle.session_year})">[[cycle.session_year]]
                                    - [[cycle.session_year+1]]</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div ng-init="List.init('student-list', {'search': 'nodaladmin/enrolledstudents/searchByName', 'getall': 'nodaladmin/enrolledstudents'})"
                ng-cloak>
                <div>
                    <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="col-sm-5 col-xs-12">
                        <div class="rt-action  pull-right" ng-controller="DownloadReportController as Download">
                            <button ng-if="List.ListService.results.length > 0" type="button"
                                ...
                                ng-click="Download.triggerDownload('nodaladmin/enrolledstudents/download?selectedCycle='+List.selectedCycle)"><i
