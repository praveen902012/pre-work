    ...
    <div class="container" ng-controller="AppController">
        <div class="rte-container">
            <div class="col-sm-10 col-12">
                <marquee behavior="scroll" direction="left">Schools that have registed on the portal during last years admission cycle can continue with their registration by clicking on "Resume Registration".</marquee>
            </div>
            <div class="col-sm-2 col-12">
                <div class="text-right" ng-init="helper.state_slug='{{$state->slug}}'">
                    <a href="" class="btn btn-green-outline mobile-mtb-20"
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <div class="heading-strip all-pg-heading " ng-init="step_value='step1'">
                        <h2>
                            School Registrations (विद्यालय पंजीकरण)
                        </h2>
                        <p>
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <form name="admin-add-school" class="common-form add-area"
                        ng-submit="School.saveSchool('{{$state->slug}}/new/school/add', '{{$state->slug}}','admin-add-school')">
                        <div id="exTab1">
                            <ul class="nav nav-pills reg-nav-block responsive-nav-bar">
                                <li class="active">
                                    <a class="step-link">
                                            ...
                                            ng-init="getAPIData('{{$state->slug}}/get/levels/all', 'levels')">
                                                ...
                                                <span ng-repeat="level in levels" ng-cloak>
                                                    <label class="custom-check">
                                                        <input type="radio" validator="required" valid-method="blur"
                                                            ng-required name="levels" id="[[level.id]]"
                                                            value="[[level.id]]"
                                                            ng-model="School.schoolData.level">[[level.level]]
                                                        
                                                        <p class="hindi-lbl">
                                                            <span ng-if=" level.level == 'Class 1'">
                                                                (कक्षा - 1)
                                                            </span>
                                                            <span ng-if=" level.level == 'Pre-Primary'">
                                                                (पूर्व प्राथमिक)
                                                            </span>
                                                        </p>
                                                    </label>
                                                ...
                                                <div class="clearfix">
                                                    <span class="uploaded-img">
                                                        <img width="300" style="width:100px;"
                                                            ...
                                                            ngf-thumbnail="School.schoolData.image" />
                                                    </span>
                                                    <span class="upload-action">
                                                        <span ngf-drop ngf-select ng-model="School.schoolData.image"
