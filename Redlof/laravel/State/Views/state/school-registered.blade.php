...
<section class="page-height section-spacing cm-content bg-grey" ng-controller="AppController"
    ng-init="getAPIData('{{$state->id}}/applicationcycle/get', 'applicationCycle');selectedCycle='{{$current_cycle}}'">
    <div class="container" ng-controller="ListController as List" ng-cloak
        ng-init="List.init('school-list', {'getall': '{{$state->slug}}/get/schools/all/'+[[selectedCycle]], 'search': '{{$state->slug}}/schools/all/'+[[selectedCycle]]+'/search'})">
        <div class="rte-container">
            <div class="row">
                    ...
                    <div class="heading-strip">
                        <h2>
                            ...
                            <span class="info-icon">
                                <i class="fa fa-info-circle" aria-hidden="true" uib-tooltip="List of registered schools"
                                    tooltip-class="ttc-verified" tooltip-placement="right"></i>
                            </span>
                        </h2>
                    </div>
                </div>
                <div class="col-sm-5 col-xs-12">
                    <div class="pull-right">
                        <div class="select-option">
                            ...
                            <select class="form-control" ng-model="selectedCycle" id="applicationcycle"
                                name="applicationcycle"
                                ng-click="List.init('school-list', {'getall': '{{$state->slug}}/get/schools/all/'+[[selectedCycle]], 'search': '{{$state->slug}}/schools/all/'+[[selectedCycle]]+'/search'})">
                                <option value="null">Admission Cycle</option>
                                <option value="[[cycle.session_year]]" ng-repeat="cycle in applicationCycle">
                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="search-action clearfix">
                        <form class="">
                            ...
                            <button class="btn-theme btn-blue" ng-click="List.search(keyword)"
                    ...
                    <div class="table-responsive bg-wht">
                        <div class="rte-table" style="border: 0;">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr ng-repeat="school in List.ListService.results" style="width: 100%;">
                                        <td class="">[[$index+1]]</td>
