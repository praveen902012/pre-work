...
<section class="page-height section-spacing cm-content bg-grey">
	<div class="container" ng-controller="AppController" ng-init="getAPIData('{{$state->id}}/applicationcycle/get', 'applicationCycle');selectedCycle='{{$current_cycle}}'">
		<div class="rte-container" ng-controller="ListController as List" ng-init="List.init('student-list', {'getall': '{{$state->id}}/general-information/students/rejected/'+[[selectedCycle]], 'search':'{{$state->id}}/general-information/students/rejected/'+[[selectedCycle]]+'/search'})">
			<div class="row">
				<div class="col-sm-7 col-xs-12">
					<div class="heading-strip">
						...
						<span class="info-icon">
							<i class="fa fa-info-circle" aria-hidden="true" uib-tooltip="List of rejected students" tooltip-class="ttc-verified" tooltip-placement="right"></i>
						</span>
						</h2>
					</div>
				</div>
				<div class="col-sm-5 col-xs-12">
					<div class="pull-right">
						<div class="select-option">
							...
							<select class="form-control" ng-model="selectedCycle" id="applicationcycle" name="applicationcycle" ng-click="List.init('student-list', {'getall': '{{$state->id}}/general-information/students/rejected/'+[[selectedCycle]], 'search':'{{$state->id}}/general-information/students/rejected/'+[[selectedCycle]]+'/search'})" >
