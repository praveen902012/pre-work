			...
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<div class="heading-strip">
						<h2>
							{{ googletrans('छात्र लॉटरी परिणाम ', $_COOKIE['lang']) }} <span>
							{{date("Y")}}-{{date("y")+1}}
						</span>
						</h2>
					</div>
					<h3>
						{{ googletrans('क्रुपया अपनी पंजीकरण आई.डी को परिणाम जानने हेतु दर्ज करे', $_COOKIE['lang']) }}
					</h3>
					<div class="search-action-result">
						<form name="student-result" id="student-result" ng-submit="create('{{$state->slug}}/student/registration/result', formData, 'student-result')">
							<div class="row">
								<div class="col-sm-9 col-xs-12">
									<div class="form-group">
										<input type="text" name="" placeholder="Search by Registration ID" class="form-control" ng-model="formData.registration_no">
									</div>
								</div>
