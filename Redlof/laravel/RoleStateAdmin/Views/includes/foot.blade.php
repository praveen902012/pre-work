...
<script src="//maps.googleapis.com/maps/api/js?libraries=placeses,geometry,places&key=AIzaSyCxB9X5tlSiZTK-o1KF6j786jZMvzK7BjY">
    </script>
...
{!! Html::script(getAsset('js/role-stateadmin.js')) !!}
