    ...
    <div class="container-fluid" ng-controller="ListController as List" ng-init="List.selectedCycle={{$latest_application_cycle->session_year}}">
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <div class="all-admin-link">
                    ...
                    <a href="{{ route('stateadmin.allotedstudents') }}">
                    ...
                    <a href="{{route('stateadmin.dismissedstudents')}}">
                        <button class="btn btn-primary">ख़ारिज छात्र</button>
                    </a>
                </div>
            </div>
                ...
                <div class="pull-right">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                <li ng-repeat="cycle in admissionCycle"><a href=""
                                        ng-click="List.selectedCycle=cycle.session_year;List.init('student-list', {'getall': 'stateadmin/dismissedstudents?selectedCycle='+cycle.session_year, 'search':'stateadmin/dismissedstudents/search?selectedCycle='+cycle.session_year })">[[cycle.session_year]]
                    ...
                    <div class="form-group" ng-controller="DownloadReportController as Download">
                        <button ng-disabled="Download.inProcess" ng-if="List.ListService.results.length > 0" type="button"
                            class="btn btn-warning pull-right" ng-click="Download.triggerDownload('stateadmin/download/dismissedstudents?selectedCycle='+List.selectedCycle)">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <div ng-init="List.init('student-list', {'getall': 'stateadmin/dismissedstudents', 'search':'stateadmin/dismissedstudents/search'})"
                    ng-cloak>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                                    ...
                                    <table class="table table-fixed">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="student in List.ListService.results">
                                                ...
                                                <td class="col-xs-3">[[student.school.name]]</td>
                                                <td class="col-xs-1">
                                                    <button ng-if="{{date('Y',strtotime('now'))}}=='{{$latest_application_cycle->session_year}}'" ng-really-action="re-allot" ng-really-message="Do you want to re-allot this student?" ng-really-click="create('stateadmin/dismissedstudents/[[student.id]]/re-allot')" class="btn btn-warning btn-xs city-action-btn">
                                                        Re-Allot
                                                    </button>
                                                </td>
                                            </tr>
