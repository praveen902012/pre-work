                ...
                <div class="pull-right">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                <li ng-repeat="cycle in admissionCycle"><a href=""
                                        ng-click="List.selectedCycle=cycle.session_year;List.init('student-list', {'getall': 'stateadmin/registeredstudents?selectedCycle='+cycle.session_year, 'search':'stateadmin/registeredstudents/search?selectedCycle='+cycle.session_year})">[[cycle.session_year]]
                    ...
                    <div class="form-group" ng-controller="DownloadReportController as Download">
                        <button ng-disabled="Download.inProcess" ng-if="List.ListService.results.length > 0" type="button"
                            class="btn btn-warning pull-right" ng-click="Download.triggerDownload('stateadmin/download/registeredstudents?selectedCycle='+List.selectedCycle)">
                                    ...
                                    <table class="table table-fixed">
                                        <thead class="thead-cls">
                                            <tr>
                                                ...
                                                <th class="col-xs-2">Verification status</th>
                                        ...
                                        <tbody>
                                            <tr ng-repeat="student in List.ListService.results">
                                                ...
                                                <td class="col-xs-2">
                                                    <a href="students/[[student.registration_no]]" target="_blank" class="btn btn-blue-outline">View</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
