...
<section ng-controller="AppController" ng-cloak>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <button ng-click="openPopup('stateadmin', 'school', 'update-school-admin-mobile', 'create-popup-style');helper.school_id='{{$school->id}}'" class="btn btn-primary" style="float: right; margin-bottom: 15px;">
                    Update school admin number
                </button>
                <button ng-click="openPopup('stateadmin', 'school', 'add-school-wards', 'lg-popup-style');helper.school_id='{{$school->id}}'" class="btn btn-primary" style="float: right; margin-bottom: 15px;margin-right: 15px;">
                    Add school wards
                </button>

                @if(count($school_levels) !== 0)
                    <button ng-click="openPopup('stateadmin', 'school', 'update-seat-info', 'lg-popup-style');helper.school_udise='{{$school->udise}}'" class="btn btn-primary" style="float: right; margin-bottom: 15px;margin-right: 15px;">
                        Update seat info
                    </button>
                @endif

                @if($currSchoolCycle && $currSchoolCycle->status == 'verified')
                    <button ng-click="openPopup('stateadmin', 'school', 'recheck-school', 'lg-popup-style');helper.school_id='{{$school->id}}'" class="btn btn-primary" style="float: right; margin-bottom: 15px;margin-right: 15px;">
                        Recheck
                    </button>
                @endif
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            <strong>No. of student applied:</strong> {{$school->no_reg_students}}
                        </p>
                        <p>
                            <strong>No. of student only applied to this school:</strong> {{$school->only_no_reg_students}}
                        </p>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-xs-12">
                ...
                @endif
                <div class="panel panel-warning">
                    <div class="panel-heading">Neighbourhood details (In Blocks)</div>
                    <div class="panel-body">
                        <table class="table table-responsive table-bordered custom-table">
                            <thead class="thead-cls">
                                <tr>
        ...
        <div class="row" ng-controller="SchoolFeeNSeatController as School" ng-init="getAPIData('stateadmin/get/school-fee-details/{{$school->id}}', 'feestructure')">
        ...
        <div class="row" ng-init="getAPIData('stateadmin/get/school-allottment-details/{{$school->id}}', 'applicationCycles')">
