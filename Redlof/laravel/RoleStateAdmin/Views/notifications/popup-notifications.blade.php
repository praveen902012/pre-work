			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="container-fluid">
						<div class="row" >
							<form name="addnotification" class="common-form addnotification" ng-submit="Notification.triggerNotification()">
								<div class="row">
									<div class="col-sm-12">
										...
										<textarea class="form-control" ng-model="Notification.notificationData.content" rows="8" placeholder="Enter Popup content" required>
											</textarea>
									</div>
								</div>
							</div>
