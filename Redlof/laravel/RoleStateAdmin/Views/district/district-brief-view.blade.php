<section class="bg-rt dy-content-slide">
				...
				<div class="detail-card-st">
					<div class="row">
						...
						<div class="col-sm-3 col-xs-12">
							<a ng-href="{{ route('stateadmin.district.district-admin', $district->id) }}" class="btn-theme btn-sm pull-right">Details</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row detail-card-st" >
		<div class="col-sm-4 col-xs-12">
			<a ng-href="{{ route('stateadmin.district.blocks', $district->id) }}" class="btn btn-warning">
				Manage Blocks
			</a>
		</div>
	</div>
