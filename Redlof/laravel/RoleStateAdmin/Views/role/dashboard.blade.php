@extends('stateadmin::includes.layout-dashboard')
@section('content')
...
<div class="state-single cm-content dash_content" ng-controller="AppController">
    <div class="" ng-controller="DashboardController as Dashboard">
        <div class="" ng-init="getAPIData('stateadmin/state/details/{{$state_id}}', 'state_details')">
    ...
    <div class="dashboard_container">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                ...
                <div class=""
                    ng-init="Dashboard.formData.selectedCycle='{{$current_cycle}}';Dashboard.formData.selectedDistrict='null';Dashboard.formData.selectedNodal='null';Dashboard.formData.selectedSchool='null';Dashboard.formData.selectedSex='null';Dashboard.formData.selectedCategory='null';Dashboard.applyFilterStudentDetails('stateadmin/apply-filter/student-details/false', Dashboard.formData);">
                    
                    <div class="row" ng-cloak>
                        <div class="col-sm-8">
                            <div ng-show="Dashboard.show_student_details" ng-cloak>
                                <form name="student-details" class="d_board_form"
                                    ng-submit="Dashboard.applyFilterStudentDetails('stateadmin/apply-filter/student-details/true', Dashboard.formData)">
                                    <div class="form-inline">
                                        ...
                                        <div class="form-group">
                                            <button
                                                ...
                                                type="submit" class="btn btn-primary btn-theme">Apply filters</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <button class="btn btn-info float-right" ng-disabled="!Dashboard.show_school_information"
                                ng-click="Dashboard.getSchoolInfo(Dashboard.selectedCycle,Dashboard.selectedDistrict,Dashboard.selectedNodal,'true');Dashboard.applyFilterStudentDetails('stateadmin/apply-filter/student-details/true', Dashboard.formData)">
        ...
        <div ng-show="Dashboard.show_student_details" ng-cloak>
            <div class="row" ng-cloak>
                ...
                {{-- <span ng-repeat="item in Dashboard.studentFilteredData.data.students_applied_for_diff_cycles">
                    <div class="school_det_cart" ng-if="item.cycle > 1">
                        <div class="ttl_new_count_card">
                            <h2>[[item.applied_students.length]]</h2>
                            <p>Students applied for cycle [[item.cycle]]</p>
                        </div>
                    </div>
                </span> --}}
            </div>
        ...
        <div class=""
            ng-init="Dashboard.initAdmissionCycle();Dashboard.selectedCycle='{{$current_cycle}}';Dashboard.initDistricts();Dashboard.selectedDistrict='null';Dashboard.initNodals(Dashboard.selectedDistrict); Dashboard.selectedNodal='null';Dashboard.getSchoolInfo(Dashboard.selectedCycle,Dashboard.selectedDistrict,Dashboard.selectedNodal, 'false')">
            <div ng-show="Dashboard.show_school_information" ng-cloak>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-12" style="padding:10px">
                    </div>
                </div>
            </div>
        </div>
