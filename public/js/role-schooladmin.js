...
angular.module('app.role-schooladmin', ['app.core']);
...
(function () {
    ...
    SchoolController.$inject = ['Helper', 'AppTableListService', '$scope', 'ApiHelper', 'ServerMessage', '$rootScope', 'NgMap', 'Toast', 'AddSchoolService'];
    ...
    function SchoolController(Helper, AppTableListService, $scope, ApiHelper, ServerMessage, $rootScope, NgMap, Toast, AddSchoolService) {
        ...
        vm.resetAllSchool = function () {


            ApiHelper.getAPIData('schooladmin/school/reset/all').then(function (response) {
        ...
        vm.saveSchool = function (API) {

            vm.inProcess = true;

            if (vm.addSchoolService.config.admin_phone_verified) {

                vm.saveSchoolPrimary(API);

                vm.inProcess = false;
            } else {

                ApiHelper.postData('schooladmin/school/verify/phone', vm.schoolData).then(function (response) {
                    vm.validationCheck = response.data.validation_check;
                    vm.inProcess = false;
                    ...
                    if (vm.validationCheck === true) {
                        ...
                        $rootScope.openPopup('schooladmin', 'school', 'school-verify-otp', 'create-popup-style sm-popup-style');
                    }
        ...
        vm.verifySchoolOtp = function (otp) {
            ...
            ApiHelper.postData('schooladmin/school/verify/phone/otp', vm.addSchoolService.config).then(function (response) {
                ...
                if (response.data.success) {
                    ...
                    vm.saveSchoolPrimary(vm.addSchoolService.config.API);
                }
        ...
        vm.saveSchoolPrimary = function (API) {
        ...
        vm.saveSchoolNeighbourhood = function (udise) {
            ...
            ApiHelper.addItem('schooladmin/school/update/region/' + udise, vm.schoolData).then(function (response) {
                ServerMessage.show(response.data);
        ...
        vm.getSchoolDetails = function (id) {
            ...
            ApiHelper.getData('schooladmin/get/school-details/' + id).then(function (response) {

                vm.schoolData = response.data;

                vm.schoolData = vm.addSchoolService.config = response.data;
        ...
        vm.getSchoolAddressDetails = function (id) {
            ...
            ApiHelper.getData('schooladmin/get/school-address-details/' + id).then(function (response) {
        ...
        vm.getSchoolRegionDetails = function (udise) {
            ...
            ApiHelper.getAPIData('schooladmin/get/school-region-details/' + udise).then(function (response) {
        ...
        vm.getSchoolBankDetails = function (id) {
            ...
            ApiHelper.getAPIData('schooladmin/get/school-bank-details/' + id).then(function (response) {
    ...
    function SchoolFeeNSeatController(Helper, AppTableListService, $scope, ApiHelper, ServerMessage, $rootScope, Toast) {
        ...
        vm.initSeatDetails = function (udise) {
            ...
            ApiHelper.getAPIData('schooladmin/get/school-seat-details/' + udise).then(function (response) {
        ...
        vm.initSeatInfo = function (slug, udise) {
            ...
            ApiHelper.getAPIData('schooladmin/get/past-seat-details/' + udise).then(function (response) {
        ...
        vm.submitDetails = function (feestructure, seatinfo, udise) {
            ...
            ApiHelper.addItem('schooladmin/school/update/seat/' + udise, data).then(function (response) {
