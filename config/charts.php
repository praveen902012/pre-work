...
return [
	...
	*/
	...
	'default' => [
		...
		'background_color' => '', // The chart division background color.
		'colors' => [], // Default chart colors if using no template is set.
		'one_color' => false, // Only use the first color in all values.
		'template' => 'custom-material', // The default chart color template.
	...
	*/
	'templates' => [
		...
		'custom-material' => [
			'#7DABEF', '#00938F', '#45444A', '#66FF75', '#FCA252', '#8F65ED', '#FE347D', '#DDDF44',
		],
	],
